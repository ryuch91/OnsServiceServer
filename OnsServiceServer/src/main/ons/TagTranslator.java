...
import org.fosstrak.tdt.NoisyMap;
...
public class TagTranslator extends TestCase{
	...
	******/
	...
	protected void setUp() {
		...
		System.out.println(this.getClass().getClassLoader().getResource("auxiliary/ManagerTranslation.xml"));
		URL schemesdir = this.getClass().getClassLoader().getResource("schemes/");
		System.out.println(this.getClass().getClassLoader().getResource("schemes/"));
